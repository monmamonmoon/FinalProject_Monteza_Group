						...
						<div class="col-xxl-6 col-lg-6 col-12 nftmax-hidden-rp">
							<div class="nftmax-wc__inner nft-gr-primary">
								...
								<div class="nftmax-wc__heading">
									<h2 class="nftmax-wc__title">Welcome to Nftmax <br> USER Panel</h2>
								</div>
						...
						<div class="col-xxl-6 col-lg-6 col-12">
							...
							<div class="nftmax-wc__form">
								<div class="nftmax-wc__form-inner">
									...
									<!-- Sign in Form -->
									<form class="nftmax-wc__form-main" action="{{route('login')}}" method="post">
										@csrf
										<div class="form-group">
											...
											<div class="form-group__input">
												...
												<input class="nftmax-wc__form-input" type="email" id="email" name="email" placeholder="demo232@gmail.com" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="form-group__input">
												...
												<input class="nftmax-wc__form-input" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" id="password" type="password" name="password" placeholder="" maxlength="8" required="required">
											</div>
										</div>
										...
										<div class="form-group">
											<div class="nftmax-wc__bottom">
												<p class="nftmax-wc__text">Dont’t have an aceount ? <a href="create-account.html">Sign up free</a></p>
											</div>
										</div>
									</form>	
									<!-- End Sign in Form -->
