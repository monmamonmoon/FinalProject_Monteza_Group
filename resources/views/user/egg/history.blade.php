...
<div class="nftmax-table mg-top-40">
    <div class="nftmax-table__heading">
        <h3 class="nftmax-table__title mb-0">All EGG TRANSACTION<span class="nftmax-table__badge">435</span></h3>
                            ...
                            <td class="nftmax-table__column-1 nftmax-table__data-1">
                                <div class="nftmax-table__product">
                                    ...
                                    <div class="nftmax-table__product-content">
                                        <h4 class="nftmax-table__product-title">{{ $transaction->batchEggs->batch_name ?? 'N/A' }}</h4>
                                    </div>
                                </div>
                            </td>
