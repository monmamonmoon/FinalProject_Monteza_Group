...
<html class="no-js" lang="zxx">
	...
	<![endif]-->
		...
		<div class="body-bg" style="background-image:url('img/body-bg.jpg')">
			...
			<!-- NFTMax Welcome -->
			<section class="nftmax-wc nftmax-wc__account nftmax-wc__full">
				<div class="container-fluid">
					<div class="row g-0">
						<div class="col-xxl-6 col-lg-6 col-md-6 col-12 nftmax-hidden-rp">
										...
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													<label class="nftmax-wc__form-label" for="name" :value="__('Name')" >Name:</label>
													<div class="form-group__input">
														...
														<input class="nftmax-wc__form-input" type="text" name="name" :value="old('name')"  autofocus autocomplete="name" placeholder="Adomx" required="required">
													</div>  
												</div>
											</div>
											<div class="col-12">
												<div class="form-group">
													<label class="nftmax-wc__form-label"  for="email" :value="__('Email')" >Email Address</label>
													<div class="form-group__input">
														...
														<input class="nftmax-wc__form-input" type="email" name="email" :value="old('email')"  autocomplete="username" placeholder="demo232@gmail.com" required="required">
													</div>
												</div>
											</div>
											<div class="col-12">
												<div class="form-group">
													<label class="nftmax-wc__form-label" for="password" :value="__('Password')" >Password</label>
													<div class="form-group__input">
											...
											<div class="col-12">
												<div class="form-group">
													<label class="nftmax-wc__form-label" for="password_confirmation" :value="__('Confirm Password')">Re-enter Password</label>
													<div class="form-group__input">
														<span class="nftmax-wc__icon"><svg class="inline" width="18" height="21" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.4467 7.1581V5.94904C14.4467 2.66455 11.7822 0 8.49771 0C5.21323 0 2.54867 2.66455 2.54867 5.94904V7.1581C1.00076 7.83194 -0.000366211 9.36059 -0.000366211 11.0471V16.149C0.0034843 18.494 1.90178 20.3961 4.25059 20.4H12.7525C15.0975 20.3961 16.9996 18.4978 17.0035 16.149V11.051C16.9919 9.36059 15.9908 7.83579 14.4467 7.1581ZM9.34482 14.451C9.34482 14.9207 8.96362 15.3019 8.49386 15.3019C8.0241 15.3019 7.6429 14.9207 7.6429 14.451V12.749C7.6429 12.2793 8.0241 11.8981 8.49386 11.8981C8.96362 11.8981 9.34482 12.2793 9.34482 12.749V14.451ZM12.7448 6.8H4.24289V5.94904C4.24289 3.60023 6.14505 1.69807 8.49386 1.69807C10.8427 1.69807 12.7448 3.60023 12.7448 5.94904V6.8Z" fill="#374557" fill-opacity="0.6"></path></svg></span>
												...
												<div class="form-group">
													<div class="nftmax-wc__check-inline">
														...
														<div class="nftmax-wc__checkbox">
															<input class="nftmax-wc__form-check" id="checkbox" name="checkbox" type="checkbox" required>
											...
											<div class="col-12">
												...
												<div class="form-group">
													<div class="nftmax-wc__bottom">
														<p class="nftmax-wc__text">Already have an aceount? <a href="{{ route('login') }}">Login</a></p>
													</div>
												</div>
											</div>
										</div>
